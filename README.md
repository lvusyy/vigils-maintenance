...
- 平台：Windows x64
- 安装方式：NSIS，当前用户安装
- 安装器：[Vigils.Maintenance_0.1.0_x64-setup.exe](https://github.com/lvusyy/vigils-maintenance/releases/download/v0.1.0/Vigils.Maintenance_0.1.0_x64-setup.exe)
- 独立程序：[uvigils.exe](https://github.com/lvusyy/vigils-maintenance/releases/download/v0.1.0/uvigils.exe)
...
1. 从 [GitHub Releases](https://github.com/lvusyy/vigils-maintenance/releases/tag/v0.1.0) 下载安装器并运行。
